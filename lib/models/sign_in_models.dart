...
//
//     final signInModels = signInModelsFromJson(jsonString);

import 'dart:convert';

SignInModels signInModelsFromJson(String str) => SignInModels.fromJson(json.decode(str));

String signInModelsToJson(SignInModels data) => json.encode(data.toJson());
...
class SignInModels {
  ...
  factory SignInModels.fromJson(Map<String, dynamic> json) => SignInModels(
    status: json["status"],
